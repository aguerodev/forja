...
- El bump de versión de `package.json` va SOLO en `release/<versión>`, que sale de `develop` y entra a `main` por PR; sobre ese merge se corta el tag `vX.Y.Z` como registro del release.
